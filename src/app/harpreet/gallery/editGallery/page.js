    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-gray-50 py-8 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <motion.div
          ...
          transition={{ duration: 0.5 }}
          className={`border-2 border-dashed rounded-xl p-6 sm:p-8 mb-8 sm:mb-12 text-center transition-all duration-300 ${isDragActive
        ...
        >
          ...
          <div className="space-y-3 sm:space-y-4">
            ...
            >
              <FiUpload className={`mx-auto h-10 w-10 sm:h-12 sm:w-12 ${isDragActive ? 'text-blue-500' : 'text-gray-400'
                }`} />
            </motion.div>
